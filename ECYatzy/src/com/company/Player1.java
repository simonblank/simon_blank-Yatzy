...
public class Player1 {
    ...
    public String SetOnes(int Dice[]){
        ...
        if(Score[0]==-1) {
            ...
            Score[0]++;
            return "Player 1 Scored "+ Score[0] + " in ones With " + Dice[0]+" "+ Dice[1]+" "+ + Dice[2]+" "+ + Dice[3]+" "+ + Dice[4];
    ...
    public String SetTwos(int Dice[]){
        ...
        if(Score[1]==-1) {
            ...
            Score[1]++;
            return "Player 1 Scored "+ Score[1] + " in twos With " + Dice[0]+" "+ Dice[1]+" "+ + Dice[2]+" "+ + Dice[3]+" "+ + Dice[4];
    ...
    public String SetThrees(int Dice[]){
        ...
        if(Score[2]==-1) {
            ...
            Score[2]++;
            return "Player 1 Scored "+ Score[2] + " in threes With " + Dice[0]+" "+ Dice[1]+" "+ + Dice[2]+" "+ + Dice[3]+" "+ + Dice[4];
    ...
    public String SetFours(int Dice[]){
        ...
        if(Score[3]==-1) {
            ...
            Score[3]++;
            return "Player 1 Scored "+ Score[3] + " in fours With " + Dice[0]+" "+ Dice[1]+" "+ + Dice[2]+" "+ + Dice[3]+" "+ + Dice[4];
    ...
    public String SetFives(int Dice[]){
        ...
        if(Score[4]==-1) {
            ...
            Score[4]++;
            return "Player 1 Scored "+ Score[4] + " in fives With " + Dice[0]+" "+ Dice[1]+" "+ + Dice[2]+" "+ + Dice[3]+" "+ + Dice[4];
    ...
    public String SetSixes(int Dice[]){
        ...
        if(Score[5]==-1) {
            ...
            Score[5]++;
            return "Player 1 Scored "+ Score[5] + " in sixes With " + Dice[0]+" "+ Dice[1]+" "+ + Dice[2]+" "+ + Dice[3]+" "+ + Dice[4];
    ...
    public String SetThreeOfAKind(int Dice[]){
        ...
        if(Score[6]==-1) {
            ...
            Score[6]++;
            return "Player 1 Scored "+ Score[6] + " in threeOfAKind With " + Dice[0]+" "+ Dice[1]+" "+ + Dice[2]+" "+ + Dice[3]+" "+ + Dice[4];
    ...
    public String SetFourOfAKind(int Dice[]){
        ...
        if(Score[7]==-1) {
            ...
            Score[7]++;
            return "Player 1 Scored "+ Score[7] + " in FourOfAKind With " + Dice[0]+" "+ Dice[1]+" "+ + Dice[2]+" "+ + Dice[3]+" "+ + Dice[4];
    ...
    public String SetFullHouse(int Dice[]){
        ...
        if(Score[8]==-1) {
            ...
            Score[8]++;
            return "Player 1 Scored "+ Score[8] + " in FullHouse With " + Dice[0]+" "+ Dice[1]+" "+ + Dice[2]+" "+ + Dice[3]+" "+ + Dice[4];
    ...
    public String SetSmallStraight(int Dice[]){
        ...
        if(Score[9]==-1) {
            ...
            Score[9]++;
            return "Player 1 Scored "+ Score[9] + " in SmallStraight With " + Dice[0]+" "+ Dice[1]+" "+ + Dice[2]+" "+ + Dice[3]+" "+ + Dice[4];
    ...
    public String SetLargeStraight(int Dice[]){
        ...
        if(Score[10]==-1) {
            ...
            Score[10]++;
            return "Player 1 Scored "+ Score[10] + " in LargeStraight With " + Dice[0]+" "+ Dice[1]+" "+ + Dice[2]+" "+ + Dice[3]+" "+ + Dice[4];
    ...
    public String SetYahtzee(int Dice[]){
        ...
        if(Score[11]==-1) {
            ...
            Score[11]++;
            return "Player 1 Scored "+ Score[11] + " in Yahtzee With " + Dice[0]+" "+ Dice[1]+" "+ + Dice[2]+" "+ + Dice[3]+" "+ + Dice[4];
    ...
    public String SetChance(int Dice[]){
        ...
        if(Score[12]==-1) {
            ...
            Score[12]++;
            return "Player 1 Scored "+ Score[12] + " in Chance With " + Dice[0]+" "+ Dice[1]+" "+ + Dice[2]+" "+ + Dice[3]+" "+ + Dice[4];
